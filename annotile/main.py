from annotile.dataloader import Dataloader, get_yolo_annotation_paths, get_yolo_image_paths
from annotile.image_tiler import ImageTiler
from pathlib import Path

class Tiler:
    def __init__(self, image_dir: Path, annotation_dir: Path, tile_size: Tuple[int, int], overlap_pct: float):
